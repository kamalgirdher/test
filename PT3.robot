...
TC1
    FOR    ${r}    IN RANGE    ${start3}    ${stop3}
        ...
        Run Keyword If    '${title[0]}'=='PASS'    Append To File    output/output3.txt    ${title[1]}##${desc[1]}##${price[1]}##${img[1]}\n
        Close Browser
    END
...
BeforeSuite
    Open Excel Document    filename=input/3.xlsx    doc_id=inp
